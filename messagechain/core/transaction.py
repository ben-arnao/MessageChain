...
# (Tier 21 — COMMUNITY_ID_HEIGHT).  v5 inherits the v4 wire layout
...
class MessageTransaction:
    ...
    def _signable_data(self) -> bytes:
        ...
        # Version 5 (Tier 21) appends the community_id presence-flag
...
def create_transaction(
    ...
    *,
    ...
    # Tier 21: opting into community_id bumps the tx to v5.  v5
