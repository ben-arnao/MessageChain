...
class Blockchain:
    ...
    def _apply_block_state(self, block: Block):
        ...
        if current_h > 0 and current_h % LOTTERY_INTERVAL == 0:
            ...
            # Bootstrap-era bounty: minted.  Fades to zero at
            ...
            if total_bounty > 0:
                ...
                if winner is not None:
                    ...
                    # Bootstrap-era bounty is minted; pool payout is
                    # moved from the consensus-visible scalar pool
                    # (total_supply unchanged for that portion).
                    if bounty > 0:
