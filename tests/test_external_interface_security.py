...
class TestEstimateFeeSizeValidation(unittest.TestCase):
    ...
    def test_estimate_fee_normal(self):
        ...
        # Need mempool.get_fee_estimate to work — accept the
        # message_bytes kwarg the size-aware estimator takes plus the
        # kw-only target_blocks the percentile-ladder estimator accepts.
        srv.mempool.get_fee_estimate = (
            lambda message_bytes=0, *, target_blocks=3: 1
        )
